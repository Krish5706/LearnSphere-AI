...
import { Shield, Key, Database, User, Save, AlertTriangle } from 'lucide-react';
                ...
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Student User" />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-2">Email Address</label>
                            <input type="email" className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg opacity-60 cursor-not-allowed" value="user@example.com" disabled />
                        </div>
                    </div>
                </div>
